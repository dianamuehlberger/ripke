...
Der Forschungsbericht untersucht die zusammenhängenden Netzwerke rund um die Fotografen Paul Ripke, Chris Schwarz, Lina Tesch und Andre Josselin auf Basis der Forschungsfrage " XXX ". 

die Beziehungsnetzwerke eines Semesters an der Hochschule. Die unterschiedlichen Beziehungsarten zeigen, dass sich Cliquen und Cluster entlang der Homophilie von Studierenden entwickelt. 
...
plot(tesch_ego, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main="Ego-Netzwerk Tesch")

rip_ego <- make_ego_graph(ripke, order = 1, nodes = V(ripke)$name == 	"Paul Ripke", mode ="all")
rip_ego <- rip_ego[[1]]
plot(rip_ego, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main="Ego-Netzwerk Rikpe")

schwarz_ego <- make_ego_graph(ripke, order = 1, nodes = V(ripke)$name == 	"Chris Schwarz", mode ="all")
schwarz_ego <- schwarz_ego[[1]]
plot(schwarz_ego, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main="Ego-Netzwerk Schwarz")

Josselin_ego <- make_ego_graph(ripke, order = 1, nodes = V(ripke)$name == 	"Andre Josselin", mode ="all")
Josselin_ego <- Josselin_ego[[1]]
plot(Josselin_ego, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main="Ego-Netzwerk Josselin")
```
...
plot(time1, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "2016")
plot(time2, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "2017")
plot(time3, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "2018")
plot(time4, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "2019", vertex.size= 5)
```
...
```{r Ego-Ripke in Jahren, fig.width=16}
...
plot(rip_time1, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Ripke 2016")
plot(rip_time2, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Ripke 2017")
plot(rip_time3, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Ripke 2018")
plot(rip_time4, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Ripke 2019")
```
...
```{r Ego-Josselin in Jahren , fig.width=16}
...
plot(Josselin_time1, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Josselin 2016")
plot(Josselin_time2, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Josselin 2017")
plot(Josselin_time3, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Josselin 2018")
plot(Josselin_time4, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Josselin 2019")
```
...
```{r Schwarz-Ego in Jahren , fig.width=16}
...
plot(schwarz_time2, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Schwarz 2017")
plot(schwarz_time3, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Schwarz 2018")
plot(schwarz_time4, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Schwarz 2019")
```
...
```{r Tesch-Ego in Jahren , fig.width=16}
...
plot(tesch_time1, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Tesch 2016")
plot(tesch_time2, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Tesch 2017")
plot(tesch_time3, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Tesch 2018")
plot(tesch_time4, layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5, vertex.color = "light blue", main = "Tesch 2019")
```
...
# Marken
plot (model1,
      layout = layout_with_kk, vertex.size=5, vertex.label.cex= 2, vertex.label.dist = 0.5,
...
__c) verwendete Datenquellen (https://raw.githubusercontent.com/dianamuehlberger/ripke/master/edgelist.csv)(https://github.com/dianamuehlberger/ripke/blob/master/nodelist.csv)__  
__d) komplettes annotiertes RNotebook ()__  
